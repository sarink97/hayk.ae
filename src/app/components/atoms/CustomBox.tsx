...
const CustomBox = (props: boxProps) => {
  return (
    <div className='relative min-w-[200px] max-w-[300px]
        ...
        <div className='relative text-xl font-semibold mt-[10px] text-cerise pt-[10px] w-[100%] text-center'>{props.title}</div>
        <div className='relative text-md text-justify'>{props.description}</div>
